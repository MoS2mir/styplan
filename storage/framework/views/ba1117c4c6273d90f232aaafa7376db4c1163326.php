            ...
            <div class="col-md-4 col-xl-4 block-types-menu">
                <div class="">
                    <div class="panel-body">
                        <input type="text" class="form-control" value="" v-model="s" placeholder="<?php echo e(__('Search for block...')); ?>">
                        <hr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\MoSamir\Downloads\public_html\public_html\modules/Template/Views/admin/detail.blade.php ENDPATH**/ ?>