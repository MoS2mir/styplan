...
<head>
    ...
    <link rel="icon" type="image/png"
        href="<?php echo e(!empty($favicon) ? get_file_url($favicon, 'full') : url('images/favicon.png')); ?>" />
...
<body class="user-page <?php echo e($body_class ?? ''); ?> <?php if(setting_item_with_lang('enable_rtl')): ?> is-rtl <?php endif; ?>">
            ...
            <div class="dashboard__main">
                <div class="dashboard__content bg-light-2">
                    <div class="container-fluid">
                        <?php echo $__env->make('User::frontend.layouts.user-header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script
        src="<?php echo e(asset('libs/filerobot-image-editor/filerobot-image-editor.min.js?_ver=' . config('app.asset_version'))); ?>"></script>
    <?php if(!is_demo_mode()): ?>
...
</html><?php /**PATH C:\Users\MoSamir\Downloads\public_html\public_html\themes/GoTrip/Layout/user.blade.php ENDPATH**/ ?>