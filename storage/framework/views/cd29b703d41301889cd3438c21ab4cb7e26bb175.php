...
?>
<?php if(Route::currentRouteName() !== 'user.profile.index'): ?>
        ...
        <div class="sidebar__user text-center mb-20">
            ...
            <div class="user-profile-info">
                <div class="info-new">
                    ...
                    <p class="text-10 mb-0">
                        <?php echo e(__("Member Since :time", ["time" => date("M Y", strtotime($dataUser->created_at))])); ?></p>
                </div>
            </div>
            <?php if(!Auth::user()->hasPermission("dashboard_vendor_access") and setting_item('vendor_enable')): ?>
                <div class="user__profile-plan mt-10 text-center">
                    <a class="become-vendor button -sm -dark-1 bg-blue-1 text-white"
                        href="<?php echo e(route("user.upgrade_vendor")); ?>"><?php echo e(__("Become a vendor")); ?></a>
                </div>
            <?php endif; ?>
        </div>
                                ...
                                <div class="sidebar__button <?php echo e($menuItem['class']); ?> col-12 d-flex items-center justify-between">
                                    <div class="d-flex items-center text-15 lh-1 fw-500">
                                        <?php if(!empty($menuItem['icon'])): ?>
                                            <a href="<?php echo e(url($menuItem['url'])); ?>" class="icon text-center mr-15 text-24"><i
                                                    class="<?php echo e($menuItem['icon']); ?>"></i></a>
                                        <?php endif; ?>
...
<?php endif; ?><?php /**PATH C:\Users\MoSamir\Downloads\public_html\public_html\themes/GoTrip/User/Views/frontend/layouts/sidebar.blade.php ENDPATH**/ ?>