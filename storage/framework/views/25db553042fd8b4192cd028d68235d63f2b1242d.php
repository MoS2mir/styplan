        ...
        <div class="gallery-custom-wrapper">
            ...
            <div class="gallery-side-column">
                <div class="gallery-target-box side-img-box">
                    <img src="<?php echo e($display_images[1]['large']); ?>" class="rounded-15 object-cover w-1/1 h-full shadow-1" style="display: block !important; opacity: 1 !important;">
                </div>
                <div class="gallery-target-box side-img-box">
                    <img src="<?php echo e($display_images[2]['large']); ?>" class="rounded-15 object-cover w-1/1 h-full shadow-1" style="display: block !important; opacity: 1 !important;">
                </div>
                <div class="mt-auto">
                    <a href="<?php echo e($display_images[0]['large']); ?>" class="button -dark-1 py-15 text-white fw-600 rounded-10 js-gallery shadow-2" data-gallery="gallery2" style="background-color: #1A2B48 !important; width: 100%; display: flex; justify-content: center; font-size: 16px; opacity: 1 !important;">
                        <?php echo e(__('عرض كل الصور')); ?>
                    ...
                    <?php $__currentLoopData = $galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($key > 0): ?> <a href="<?php echo e($item['large']); ?>" class="js-gallery" data-gallery="gallery2"></a> <?php endif; ?>
                    ...
                    <div class="swiper-wrapper h-full">
                        <?php $__currentLoopData = $galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="swiper-slide h-full" style="opacity: 1 !important; visibility: visible !important;">
                                <img src="<?php echo e($item['large']); ?>" alt="Gallery" class="object-cover w-1/1 h-full shadow-1-hover" style="display: block !important; opacity: 1 !important;">
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
            ...
            <div class="gallery-side-column">
                <div class="gallery-target-box side-img-box">
                    <img src="<?php echo e($display_images[3]['large']); ?>" class="rounded-15 object-cover w-1/1 h-full shadow-1" style="display: block !important; opacity: 1 !important;">
                </div>
                <div class="gallery-target-box side-img-box">
                    <img src="<?php echo e($display_images[4]['large']); ?>" class="rounded-15 object-cover w-1/1 h-full shadow-1" style="display: block !important; opacity: 1 !important;">
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\Users\MoSamir\Downloads\public_html\public_html\themes/GoTrip/Layout/common/detail/gallery2.blade.php ENDPATH**/ ?>