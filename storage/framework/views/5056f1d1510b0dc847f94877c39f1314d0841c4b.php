        ...
        <aside class="sidebar y-gap-40 p-4 p-lg-0">
            ...
            <div class="g-filter-item sidebar__item">
                <div class="item-title">
                    <h5 class="text-18 fw-500 mb-10"><?php echo e(__("تصنيف النجوم")); ?></h5>
                </div>
            ...
            <div class="g-filter-item sidebar__item">
                <div class="item-title">
                    <h5 class="text-18 fw-500 mb-10"><?php echo e(__("تقييم الزوار")); ?></h5>
                </div>
                <div class="item-content sidebar-checkbox">
                    <?php for($number = 5 ;$number >= 1 ; $number--): ?>
                        <div class="row y-gap-10 items-center justify-between">
...
<?php /**PATH C:\Users\MoSamir\Downloads\public_html\public_html\themes/GoTrip/Hotel/Views/frontend/layouts/search/filter-search.blade.php ENDPATH**/ ?>