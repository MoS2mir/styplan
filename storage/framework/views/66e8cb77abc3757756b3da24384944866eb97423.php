            ...
            <div class="mt-40 mb-40">
                <div class="w-100 mb-20">
                    <div class="d-flex items-center">
                        ...
                        <div class="text-14 lh-10 text-light-1"><?php echo e(__('I have read and accept the')); ?> <a target="_blank"
                                href="<?php echo e(get_page_url($term_conditions)); ?>"
                                style="color: #0d6efd; text-decoration: underline;"><?php echo e(__('terms and conditions')); ?></a>
                        </div>
                    </div>
                </div>
...
</div><?php /**PATH C:\Users\MoSamir\Downloads\public_html\public_html\themes/GoTrip/Booking/Views/frontend/booking/checkout-form.blade.php ENDPATH**/ ?>