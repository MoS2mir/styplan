<div class="top-profile-card text-center">
    <h2 style="font-size: 28px; font-weight: 700; margin-bottom: 12px; color: #000; font-family: 'Tajawal', 'Cairo', sans-serif;">
...
<div class="d-flex justify-content-center flex-wrap" style="gap: 15px; margin-bottom: 60px;">
    ...
    <a href="#" onclick="event.preventDefault(); document.getElementById('logout-form-profile').submit();" class="btn-action">
