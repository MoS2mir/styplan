        ...
        <div class="row y-gap-20 justify-start">
            <div class="col-auto">
                <div class="sectionTitle -md">
                    <h2 class="sectionTitle__title" style="font-family: 'Inter', sans-serif; font-weight: 600; font-size: 40px; line-height: 100%; color: #000000;">{!! $title ?? '' !!}</h2>
                        ...
                        <a href="{{$row->getDetailUrl()}}">
                            <div class="citiesCard -type-2 ">
                                <div class="citiesCard__image" style="width: 100%; height: 304px; border-radius: 10px; overflow: hidden; position: relative;">
                                    <img class="js-lazy" style="width: 100%; height: 100%; object-fit: cover;" data-src="{{ get_file_url($row->image_id) }}" src="#" alt="{{ $translation->name ?? '' }}">
                                    ...
                                    <div class="citiesCard__content d-flex flex-column justify-content-end" style="position: absolute; bottom: 0; left: 0; width: 100%; height: 100%; padding: 20px; background: linear-gradient(to top, rgba(0,0,0,0.8) 0%, transparent 60%); text-align: right; align-items: flex-start; pointer-events: none;">
                                        <h4 class="text-white" style="font-family: 'Inter', sans-serif; font-weight: 500; font-size: 24px; line-height: 100%;">{{ $translation->name ?? '' }}</h4>
                                        <div class="text-white">
                                            ...
                                            {{-- <span style="font-size: 10px; color: yellow;">
                                                Count: {{$count_all}} | Types: {{ implode(',', $types) }}
                                            </span> --}}
                                            {{-- DEBUG END --}}

                                            <span style="font-family: 'Inter', sans-serif; font-weight: 400; font-size: 14px; line-height: 100%;">{{$count_all}} مكان</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
