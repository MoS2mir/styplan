<footer class="footer -type-custom py-60" style="background-color: #151F30; color: white;">
    <div class="container">
        <div class="row y-gap-40 justify-between items-start">
            {{-- Right Section: Links (RTL context) --}}
            ...
            <div class="col-auto text-left">
                <div class="footer-logo">
                    ...
                    @endphp
                    @if($logo)
                        <img src="{{get_file_url($logo,'full')}}" alt="{{setting_item("site_title")}}" style="max-height: 60px;">
                    @else
            ...
            <div class="row justify-between items-center y-gap-20">
                <div class="col-auto">
                    <div class="text-white-50 text-15 fw-400">
                        جميع الحقوق محفوظة {{date('Y')}} {{setting_item('site_title')}}
                    </div>
                </div>
                <div class="col-auto">
