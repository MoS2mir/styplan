            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        {{date('Y')}} &copy; Powered by <a href="https://ektml.com" target="_blank">Ektml.com</a>
                    </div>
                    <div class="col-md-6">
                        <div class="text-md-right footer-links d-none d-sm-block">
                            <a href="https://www.ektml.com/aboutus" target="_blank">{{__('About Us')}}</a>
                            <a href="https://www.ektml.com" target="_blank">{{__('Contact Us')}}</a>
                        </div>
                    </div>
                </div>
            </div>
